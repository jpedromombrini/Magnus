...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Magnus.Core.Entities.TransferWarehouseItem", b =>
                {
                    ...
                    b.Property<Guid>("TransferWarehouseId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TransferWarehouseId1");
            ...
            modelBuilder.Entity("Magnus.Core.Entities.TransferWarehouseItem", b =>
                {
                    b.HasOne("Magnus.Core.Entities.TransferWarehouse", null)
                        .WithMany("Items")
                    ...
                    b.HasOne("Magnus.Core.Entities.TransferWarehouse", "TransferWarehouse")
                        .WithMany()
                        .HasForeignKey("TransferWarehouseId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
