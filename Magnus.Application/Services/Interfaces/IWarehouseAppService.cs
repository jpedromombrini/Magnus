...
public interface IWarehouseAppService
{
    ...
    Task<IEnumerable<WarehouseStockResponse>>
        GetStockByUserAsync(Guid warehouseId, CancellationToken cancellationToken);

    Task<IEnumerable<WarehouseResponse>> ListWarehousesByFilterAsync(Expression<Func<Warehouse, bool>> predicate,
        CancellationToken cancellationToken);

    Task<WarehouseResponse> GetWarehousesByFilterAsync(Expression<Func<Warehouse, bool>> predicate,
        CancellationToken cancellationToken);
