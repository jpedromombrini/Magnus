...
public interface IProductStockService
{
    ...
    Task SubtractProductStockAsync(Guid productId, Warehouse warehouse, int amount,
        CancellationToken cancellationToken);

    Task IncrementProductStockAsync(Guid productId, Warehouse warehouse, int amount,
        CancellationToken cancellationToken);
