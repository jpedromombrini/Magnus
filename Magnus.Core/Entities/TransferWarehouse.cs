...
public class TransferWarehouse : EntityBase
{
    ...
    public TransferWarehouse(Guid userId, string userName, int warehouseOriginId, string warehouseOriginName,
        int warehouseDestinyId, string warehouseDestinyName)
    {
        SetCreatedAt();
        SetUserId(userId);
    ...
    public List<TransferWarehouseItem> Items { get; }
    ...
    public void SetWarehouseOriginName(string warehouseOriginName)
    {
        ...
        WarehouseOriginName = warehouseOriginName.ToUpper();
    }
    ...
    public void SetWarehouseDestinyName(string warehouseDestinyName)
    {
        ...
        WarehouseDestinyName = warehouseDestinyName.ToUpper();
    }
